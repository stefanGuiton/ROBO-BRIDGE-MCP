...
- a 31-tool production WebMCP surface, including the 14 primitive robot/workcell tools documented below plus additional Simple Bricks, scene, refill/recolour and bridge-design tools;
...
The current production build registers 31 WebMCP tools. The core primitive robot/workcell tools are:
...
Additional production tools cover Simple Bricks structure planning/execution, scene controls, source refill/recolour operations and bridge design/build workflows. All tools operate on the same browser world and authoritative revisioned state.
...
## Assets, licence and attribution

ROBO BRIDGE MCP is released under the Apache License 2.0. Third-party software and assets retain their own licences and attribution requirements.

- See `LICENSE` for the project licence.
- See `ATTRIBUTIONS.md` for the human-readable asset/provenance list.
- See `THIRD_PARTY_NOTICES.md` for third-party licence notices and redistribution conditions.
- `apps/web/assets/models/train_full.glb` is a project-authored asset created from an AI-generated concept image and then converted, edited and integrated by the repository owner.
